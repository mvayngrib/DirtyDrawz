...
import ListItem from './react-native-side-menu/ListItem';
    ...
    if (this.props.checked==true)
      return (
        ...
        <TouchableOpacity onPress={()=>this.handlePress()}>
          <Image source={require('./orderAssets/cb_enabled.png')} style={{height:25,width:25}}/>
        </TouchableOpacity>
      ...
      return (
        <View style={{flexDirection:'row',alignItems:'center',}}>
        <TouchableOpacity onPress={()=>this.handlePress()}>
          <Image source={require('./orderAssets/cb_disabled.png')} style={{height:25,width:25}}/>
        </TouchableOpacity>
            <View style={{paddingLeft:20}}>
            <Text style={this.props.labelStyle}>{this.props.label}{this.props.checked}</Text>
          </View>
    ...
    return(
      <View style={styles.collapiseItem}>
        ...
        <View style={{margin:10,flex:1,flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
          <DryCleanItem imageSrc={require('./orderAssets/Suit.png')} times={this.state.Suit} onPress={()=>this.setState({Suit:this.state.Suit+1})} onPress2={()=>this.setState({Suit:this.state.Suit-1})} name="Suit" price="14.99"/>
          <DryCleanItem imageSrc={require('./orderAssets/Pants.png')} times={this.state.Pants} onPress={()=>this.setState({Pants:this.state.Pants+1})} onPress2={()=>this.setState({Pants:this.state.Pants-1})} name="Pants" price="15.99"/>
          <DryCleanItem imageSrc={require('./orderAssets/Shirt.png')} times={this.state.Shirt} onPress={()=>this.setState({Shirt:this.state.Shirt+1})} onPress2={()=>this.setState({Shirt:this.state.Shirt-1})} name="Shirt" price="13.99"/>
        </View>

        <View style={{margin:10,flex:1,flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
          <DryCleanItem imageSrc={require('./orderAssets/Jacket.png')} times={this.state.Jacket} onPress={()=>this.setState({Jacket:this.state.Jacket+1})} onPress2={()=>this.setState({Jacket:this.state.Jacket-1})} name="Jacket" price="14.99"/>
          <DryCleanItem imageSrc={require('./orderAssets/Blouse.png')} times={this.state.Blouse} onPress={()=>this.setState({Blouse:this.state.Blouse+1})} onPress2={()=>this.setState({Blouse:this.state.Blouse-1})} name="Blouse" price="15.99"/>
          <DryCleanItem imageSrc={require('./orderAssets/Goose.png')} times={this.state.Goose} onPress={()=>this.setState({Goose:this.state.Goose+1})} onPress2={()=>this.setState({Goose:this.state.Goose-1})} name="Goose" price="13.99"/>
        </View>
      </View>
      );
  }
